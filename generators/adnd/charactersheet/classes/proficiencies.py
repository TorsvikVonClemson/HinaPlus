...
def roll(race,playerclass,intel):
    ...
    proffinal=[]
    doublelist=["Mining:Wis-3","Astrology:Int","Engineering:Int-3","Healing:Wis-2","Herbalism:Int-2","Blind-Fighting:","Gem Cutting:Dex-2","Reading Lips:Int-2","Armorer:Int-2","Bowyer/Fletcher:Dex-1","Endurance:Con","Survival:Int","Tracking:Wis"]
